                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="<%= ApplicationSettings.get().getProductWebsite() %>carparts/?countryCode=<%= countryCode %>&postalCode=<%= postalCode %>&lang=<%= localeId %>#map" target="aseCarPartsPage"><img src="https://maps.googleapis.com/maps/api/staticmap?sensor=false&language=<%= localeId %>&format=png8&center=<%= postalCode %>,<%= countryLabel %>&zoom=7&size=96x96" style="vertical-align: middle; border: 2px solid #A5BEDA; border-color: #A5BEDA #A5BEDA #5C7590 #5C7590;" /></a>
